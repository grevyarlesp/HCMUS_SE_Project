...
public:
    ...
    _description, std::function<bool()> _canExecute) : iconCharacter(_iconCharacter) , description(_description) , canExecute(_canExecute)
    {
    }
...
QString& description, std::function<bool()> canExecute)
: QObject(parent)
{
